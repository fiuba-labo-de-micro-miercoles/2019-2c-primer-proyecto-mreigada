;*********************************************************************************************************************
;Encendido de un led ubicado en PORTB.2, mediante botón ubicado en PORTB.0 (usando resistencias pull-up internas)
;
...
MAIN:
	...
	OUT PUERTO_SALIDA, R16
								; Se controla el LED
CONTROLAR_LED:
	CALL DETECTAR_ALTO			; Se espera hasta que el botón en el puerto de entrada deje de estar presionado
	CBI	 PUERTO_SALIDA, LED   
	CALL DETECTAR_BAJO			; Se espera hasta que el botón en el puerto de entrada sea presionado
