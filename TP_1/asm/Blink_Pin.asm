;*************************************************************************************
;Parpadeo de un led ubicado en el PORTB.0 (Usando solo un pin)
;
...
main_loop:
	sbi PORTB, 0				;Pone el pin 0 del puerto B en un estado lógico alto
	rcall retardo_1000ms		
	cbi PORTB, 0				;Pone el pin 0 del puerto B en un estado lógico bajo
	rcall retardo_1000ms		
